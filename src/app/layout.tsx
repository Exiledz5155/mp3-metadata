...
function MusicCard() {
  ...
  return (
    <Box maxW='sm' borderWidth='1px' borderRadius='lg' h='60px' overflow='hidden'>
      <Grid 
        h='100%'
        w='100%'
        ...
        gap={0}
      >
        <GridItem rowSpan={2} colSpan={1} bg={useColorModeValue("green.400", "gray.900")}>
...
export default function Download({ children }: { children: React.ReactNode }) {
  const fileHub = ["Song1", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2", "Song2"];
  return (
    <CacheProvider>
